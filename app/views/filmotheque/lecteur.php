...
<html lang="en">
  <head>
  	<title>"Filmotheque | Lecteur"</title>
    <meta charset="utf-8">
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarScroll">
      <ul class="navbar-nav me-auto my-2 my-lg-0 navbar-nav-scroll" style="--bs-scroll-height: 100px;">
        <li class="nav-item">
        <a class="nav-link active" aria-current="page" href="<?= ROOT ?>">FILMOTHEQUE</a>
        </li>
        <li class="nav-item">
...
<div class="row border rounded-3 border-dark mt-1 mb-1">
    <h5 class="rounded-3 bg-light mb-1 mx-auto fw-bold"><span>Titre : </span><?= $row["title"]?></h5>
    <div class="row">
        <h6 class="col-3 "><span class="text-primary">Acteur : </span><?= $row["actor"]?></h6>
        <h6 class="col text-dark"><span  class="text-primary">Catégorie : </span><?= $row["category"]?></h6>       
        <h6 class="col-4"><span  class="text-primary">Tags : </span><?= $row["tags"]?></h6>
        <h6 class="col "><span  class="text-primary">Durée : </span><?= $row["duree"]?></h6>
</div> 
</div>
</div>
<?php endforeach; ?>
...
<!--  <source src="<?php echo ASSETS?>movies/A Father's Resolve (John Q).mp4" type="video/mp4">  -->
  <source src="<?php echo ASSETS?>movies/<?= $row["movie"]?>" type="video/mp4">

...
class Login extends Controller{
    ...
    public function index(){  
        ...
        $data["title"]="Filmotheque | Login";
       $this->view("login/index",$data); // le parametre $path est une chaine de caractere correspondant au chemin du fichier a afficher, a partir du dosseir views
